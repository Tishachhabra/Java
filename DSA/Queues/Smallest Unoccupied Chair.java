...
class Solution {
    public int smallestChair(int[][] times, int targetFriend) {
        ...
        // List of arrivals -[arrival time,friend index]
        ...
        for (int i = 0; i < n; i++) {                  //all chairs are available at first
            availableChairs.add(i);
        }

        // Priority queue to track when chairs are freed , contains [leavingtime,chair]
